...
#
# 3.2.18
# External Seurat functions required to run cust.func, for some reason.
# Run this b4 using cust.func, bruh
#
##########################################################################
##########################################################################
...
EvaluateCCs <- function(object, grouping.var, dims.eval, gene.num,
  ...
  # cust.func()
  #
  # this one mine right here, bruh
  #
  #

 cust.func <- function (object, reduction.use = "pca", dim.1 = 1, dim.2 = 2,
